...
plugins=(colored-man-pages git extract zoxide encode64 direnv kubectl kubectx helm podman jfrog sdk zsh-autosuggestions zsh-syntax-highlighting myapictl)
